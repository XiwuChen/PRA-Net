...
class ShapeNetPart():
    ...
    def __getitem__(self, index):
        ...
        return point_set, torch.from_numpy(seg), torch.from_numpy(cls), normal

    def __len__(self):
        return len(self.datapath)

class ShapeNetPartEval():
    def __init__(self, root, split='train', normalize=True, transforms=None):
        self.transforms = transforms
